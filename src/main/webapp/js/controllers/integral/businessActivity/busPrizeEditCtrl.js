 ...
 * 奖项修改
 */
angular.module('inspinia',['angularFileUpload']).controller('busPrizeEditCtrl',function($scope,$http,i18nService,$state,FileUploader,$stateParams){
    ...
    $scope.saveInfo=function(url){
        ...
        $http.post("activityChoice/editLuckPrize",
