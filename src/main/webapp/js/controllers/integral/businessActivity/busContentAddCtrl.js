 ...
 * 业务组-活动内容新增
 */
angular.module('inspinia').controller('busContentAddCtrl',function($scope,$http,i18nService,$state,$stateParams,SweetAlert){
    ...
    //值类型
    $scope.calcTypeSelect = [{text:"数值",value:"1"},{text:"比例",value:"2"},{text:"按交易金额返现",value:"3"},{text:"按手续费返现",value:"4"}];
    ...
    $scope.commitInfo=function(){
        ...
        $http.post("activityChoice/addActiInfo",
