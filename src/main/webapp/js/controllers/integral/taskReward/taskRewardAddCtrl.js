 ...
 * 任务新增
 */
angular.module('inspinia',['angularFileUpload']).controller('taskRewardAddCtrl',function($scope,$http,i18nService,$state,SweetAlert,FileUploader){
    ...
    //流水下发方式
    $scope.grantTypeSelect = [{value:"",text:"请选择"}];
    ...
    $scope.addInfo={taskType:"",grantType:"",taskParams:"",frequencyType:"3"};
    ...
    //流水下发方式
    $scope.grantTypeChange = function(){
    ...
    $scope.addInfoSubmit = function(){
        ...
        $http.post("taskRewardAction/addTaskRewardInfo",data,postCfg)
            .success(function(data){
                if(data.status){
