 ...
 * 活动内容新修改
 */
angular.module('inspinia').controller('contentEditCtrl',function($scope,$http,i18nService,$state,$stateParams,SweetAlert){
    ...
    $scope.getActiDetail=function(){
        $http.post("activityManagement/getActiDetail",
            "actDetCode="+$scope.actDetCode,
    ...
    $scope.commitInfo=function(){
        ...
        $http.post("activityManagement/editActiInfo",
    ...
    $scope.goBackFun=function(){
        window.open('welcome.do#/activities/activityConfig/'+$scope.addInfo.actCode+'/0', '_self');
    };
});