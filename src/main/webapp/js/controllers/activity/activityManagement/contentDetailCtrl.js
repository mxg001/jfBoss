 ...
 * 活动内容新详情
 */
angular.module('inspinia').controller('contentDetailCtrl',function($scope,$http,i18nService,$state,$stateParams,SweetAlert){
    ...
    $scope.goBackFun=function(){
        if($scope.source==1){
            window.open('welcome.do#/activities/activityConfigDetail/'+$scope.addInfo.actCode+'/0', '_self');
